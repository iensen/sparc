...
\begin{verbatim}
 ?- p(t1,t2,...,tn)
\end{verbatim}
 where  $p(t1,t2,\dots,tn)$ is an atom of loaded program $\Pi$ ( note that \textit{n} can be equal to zero, in this case the query will be of the form \textit{p} ).
...
0-arity predicates must be declared as $pred_symbol()$.
