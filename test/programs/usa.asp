...
goal(T_G,fwd_rcs):-h(maneuver_of(minus_x,fwd_rcs),T_G).
goal(T_G,left_rcs):-h(maneuver_of(minus_x,left_rcs),T_G).
goal(T_G,right_rcs):-h(maneuver_of(minus_x,right_rcs),T_G).
s_gen0(ffdummy).
s_gen0(lox12).
s_gen0(ffm1).
s_gen0(ffm2).
