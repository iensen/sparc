...
stuck(rfi12,closed).
stuck(roi12,closed).
goal(T_G,fwd_rcs):-h(maneuver_of(plus_yaw,fwd_rcs),T_G).
goal(T_G,left_rcs):-h(maneuver_of(plus_yaw,left_rcs),T_G).
goal(T_G,right_rcs):-h(maneuver_of(plus_yaw,right_rcs),T_G).
occurs(open_rfm1,4).
s_gen0(ffdummy).
s_gen0(lox12).
s_gen0(ffm1).
